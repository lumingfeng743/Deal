...
/**
 * Servlet implementation class QianKuanSvlt
 */
@WebServlet("/QianKuan.Svlt")
public class QianKuanSvlt extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Map<String, Object>> xinxi=dealservice.chaxunqiankuan();//创建列表		
